...
![Рисунок 1 – Прототип маркера](laba2_imgs/Picture1)
...
![Рисунок 2 – Расположение инструментов управления в окне Unity](laba2_imgs/Picture2)

Move   Нажмите и перетащите, чтобы переместить камеру.
Orbit   Удерживая клавишу Alt , щелкните левой кнопкой мыши и перетащите камеру, чтобы она вращалась вокруг текущей точки поворота.
Этот параметр недоступен в 2D-режиме, поскольку вид является ортогональным.
Zoom   Удерживая нажатой клавишу Alt, щелкните правой кнопкой мыши и перетащите, чтобы увеличить представление сцены.
...
![Рисунок 3 – Визуальное отображение разных инструментов](laba2_imgs/Picture3)
...
![Рисунок 4 – Объединение элементов в группу](laba2_imgs/Picture4)
...
![Рисунок 5 – Положение точки захвата](laba2_imgs/Picture5)

В результате у вас должен получиться маркер
 
![Рисунок 6 – Пример объекта «Маркер»](laba2_imgs/Picture6)
...
![Рисунок 7 – Кнопка добавления компонентов к игровому объекту](laba2_imgs/Picture7)
